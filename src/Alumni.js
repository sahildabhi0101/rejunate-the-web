  ...
  return (
   <div className="ind">
    ...
    <div className="contact">
        &nbsp; <a href="https://www.facebook.com/BVMEngineeringCollege/" target="_blank" rel="noreferrer"><i className="fa fa-facebook-square" ></i></a>
        &nbsp; <a href="https://www.linkedin.com/in/bvmcollege/?originalSubdomain=in" target="_blank" rel="noreferrer"><i className="fa fa-linkedin-square" ></i></a>
        &nbsp;  <a href="https://www.instagram.com/bvmtpc/?hl=en" target="_blank" rel="noreferrer"><i className="fa fa-instagram" ></i></a>
        &nbsp;  <a href="https://twitter.com/bvmtpc?lang=en" target="_blank" rel="noreferrer"><i className="fa fa-twitter-square" ></i></a>
        &nbsp;  <a href="https://www.youtube.com/watch?v=hqFIUhV8iA0" target="_blank" rel="noreferrer"><i className="fa fa-youtube-square" ></i></a>
        </div>
